...
class TestBiosphereInformationPotential:
    ...
    def test_higher_discount_reduces_potential(self):
        ...
        Phi_low = biosphere_information_potential(
            D=0.5, bandwidth=1e12, discount_rate=0.01
        )
        Phi_high = biosphere_information_potential(
            D=0.5, bandwidth=1e12, discount_rate=0.1
        )
